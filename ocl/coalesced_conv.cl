__kernel void coalesced_convolution(__global float *inputs, 	__global float *weights, 	
								...
								)
{
	...
	int idx = global_y*gxsize + global_x;

	for (k=idx; k<K*C*k_size*k_size; k+=gxsize*gysize){
